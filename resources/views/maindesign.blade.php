                ...
                <div class="row">
                    <div class="col-sm-8 text-sm">
                        <div class="site-info">
                            ...
                            <a href="#"><span class="mai-mail text-primary"></span> sandeeppal270@gmail.com </a>
                        </div>
                    </div>
    ...
    <footer class="page-footer">
        <div class="container">
            <div class="row px-md-3">
                ...
                <div class="col-sm-6 col-lg-3 py-3">
                    <h5>Contact</h5>
                    <p class="footer-link mt-2">India</p>
                    <a href="#" class="footer-link">+91 - 1234567890</a>
                    <a href="#" class="footer-link">sandeeppal270@gmail.com</a>
            ...
            <p id="copyright">Copyright &copy; 2025 <a href="https://macodeid.com/" target="_blank"> Sandeep Pal </a>.
